...
//DOM element - para comprobar si el elemento existe en la pagina actual
...
if (mapBox) {
    //Se cargan las ubicaciones que obtuvimos del html del tour especifico
    const locations = JSON.parse(document.getElementById("map").dataset.locations);
    (0, _mapbox.displayMap)(locations);
}
if (loginForm) //Se crea el evento que ocurrira cuando el usuario de click en le boton de login
loginForm.addEventListener("submit", (e)=>{
    //Para evitar que se carguen otras paginas
    e.preventDefault();
    //Valores para hacer el login
